== 2013-01-12 (0.0.14.1)
* Added the option: <tt>-P</tt> / <tt>--cloudstack-project</tt> to the following oommands: <tt>account list</tt>, <tt>firewallrule list</tt>, <tt>hosts</tt>,
...
* Added option: <tt>--action</tt> to <tt>server list</tt> to <tt>start</tt> or <tt>stop</tt> the machines.
