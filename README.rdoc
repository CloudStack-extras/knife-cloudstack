...
--fieldlist 		This will display the fields that you can use to filter or use in your output. 
...
--keyword		Filters your output on the instance name that you specify: Example: --keyword "i-324"
			This will display all servers with 'i-324' inside the instancename.

--name 			Filters your output on the name that you specify. Example: --name "chef" 
			This will display all servers with 'chef' inside the hostname.

--action		This action will be executed on the output of the list command. Actions can be start or stop.
