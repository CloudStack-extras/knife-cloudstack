...
<tt>--keyword</tt>		Filters your output on the instance name that you specify: Example: <tt>--keyword "i-324"</tt>
			This will display all servers with 'i-324' inside the instancename.

<tt>--name</tt> 			Filters your output on the name that you specify. Example: <tt>--name "chef"</tt> 
			This will display all servers with 'chef' inside the hostname.
...
--listall		This will list all the networks, depending on the accout that you are using.

--keyword		Filters your output on the keyword that you specify. Example: --keyword "network1" 
			This will display all networks with 'network1' inside the name.
...
--name			Filters your output on the name that you specify. Example: --name "medium" or --keyword "medium"
...
Use the -F (or --templatefilter) option to use a different filter. The allowable filter values are:
...
--listall		This will list all the templates, depending on the accout that you are using.
...
--keyword		Filters your output on the keyword that you specify. Example: --keyword "zone1" 
			This will display all zones with 'zone1' inside the name

=== knife cs hosts
Convenience command that displays the public ip address and fqdn for all servers. Matches /etc/hosts file format.

--listall		This will list all the servers, depending on the accout that you are using.
...
--listall		This will list all the possible results, depending on the accout that you are using.
...
--listall		This will list all the domains, depending on the accout that you are using.

==== knife cs firewallrule list

--listall		This will list all the firewallrules, depending on the accout that you are using.
...
--listall		This will list all the iso's, depending on the accout that you are using.
...
--listall		This will list all the projects, depending on the accout that you are using.
...
--listall		This will list all the routers, depending on the accout that you are using.
...
--listall		This will list all the users, depending on the accout that you are using.

--keyword		Filters your output on the keyword that you specify.

==== knife cs volume list:	

--listall		This will list all the volumes, depending on the accout that you are using.
