...
<tt>--filter</tt> 		Filters your output on the fields that you specify. Filter can be a string 'name' or regexp '/name/i'
			Example: --filter "instancename:/i-xxx/i, account:accname"

<tt>--fields</tt> 		The fields that you want to display in your output. Default outputs will be shown if no fields are defined.
			Example: --fields "name, instancename, domain"

<tt>--fieldlist</tt> 		This will display the fields that you can use to filter or use in your output. 
			Example will be given with the first result that you specify in your filter.
...
<tt>--listall</tt>		This will list all the servers, depending on the accout that you are using.

<tt>--keyword</tt>		Filters your output on the instance name that you specify: Example: <tt>--keyword "i-324"</tt>
			This will display all servers with <tt>'i-324'</tt> inside the instancename.

<tt>--name</tt> 			Filters your output on the name that you specify. Example: <tt>--name "chef"</tt> 
			This will display all servers with <tt>'chef'</tt> inside the hostname.

<tt>--action</tt>		This action will be executed on the output of the list command. Actions can be start or stop.
...
when creating a new server by passing the network name as an argument to the <tt>-W</tt> (or <tt>--network</tt>) option of the
<tt>knife cs server create</tt> command.

<tt>--listall</tt>		This will list all the networks, depending on the accout that you are using.

<tt>--keyword</tt>		Filters your output on the keyword that you specify. Example: <tt>--keyword "network1"</tt> 
			This will display all networks with <tt>'network1'</tt> inside the name.
...
<tt>--name</tt>			Filters your output on the name that you specify. Example: <tt>--name "medium"</tt> or <tt>--keyword "medium"</tt>
			This will display all cpu service offerings with 'medium' inside the name.
...
Use the <tt>-F</tt> (or <tt>--templatefilter</tt>) option to use a different filter. The allowable filter values are:
...
A template can be specified when creating a new server by passing the template name as an argument to the <tt>-T</tt
(or <tt>template</tt>) option of the <tt>knife cs server create</tt> command.

<tt>--listall</tt>		This will list all the templates, depending on the accout that you are using.

=== knife cs zone list
Displays a list of all zones available in the currently configured CloudStack account. A zone can be specified
when creating a new server by passing the zone name as an argument to the <tt>-Z</tt> (or <tt>--zone</tt>) option of the
<tt>knife cs server create</tt> command.

<tt>--keyword</tt>		Filters your output on the keyword that you specify. Example: <tt>--keyword "zone1"</tt> 
			This will display all zones with <tt>'zone1'</tt> inside the name
...
<tt>--listall</tt>		This will list all the possible results, depending on the accout that you are using.
...
<tt>--listall</tt>		This will list all the domains, depending on the accout that you are using.

==== knife cs firewallrule list

<tt>--listall</tt>		This will list all the firewallrules, depending on the accout that you are using.
...
<tt>--listall</tt>		This will list all the iso's, depending on the accout that you are using.
...
==== knife project iso list

<tt>--listall</tt>		This will list all the projects, depending on the accout that you are using.
...
<tt>--listall</tt>		This will list all the routers, depending on the accout that you are using.
...
<tt>--listall</tt>		This will list all the users, depending on the accout that you are using.

<tt>--keyword</tt>		Filters your output on the keyword that you specify.

==== knife cs volume list:	

<tt>--listall</tt>		This will list all the volumes, depending on the accout that you are using.
